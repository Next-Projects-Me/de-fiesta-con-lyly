...
export const AdminOrdersTable = ({ page }: Props) => {
    ...
    const getInitialOrders = useCallback(async (data?: Inputs) => {
        ...
        const { ok, orders = [], totalPages, totalCount } = await getAllOrders({ page, ...data, isAdminPage: true });
    ...
    }, [reset, page, searchAdminOrders, getInitialOrders]);
